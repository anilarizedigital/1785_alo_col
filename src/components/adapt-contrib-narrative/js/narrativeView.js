define([
    ...
    var NarrativeView = ComponentView.extend({
        ...
        events: {
            'click .narrative-strapline-title': 'openFeedbackPopup',
        ...
        calculateMode: function() {
            var mode = (Adapt.device.screenSize === 'large' || Adapt.device.screenSize === 'medium') ?
                MODE.LARGE :
                MODE.SMALL;
        ...
        openFeedbackPopup: function(event) {
            ...
            var stage = currentItem.get('_index');
            this.playAudio(stage);

            Adapt.on('popup:closed', this.onPopupClosed, this);
        },
        ...
        onPopupClosed: function() {
            ...
            // Remove event binding for popup closed
            Adapt.off('popup:closed', this.onPopupClosed);
        },
        ...
        onNavigationClicked: function(event) {
            ...
            if (this.isLargeMode()) {
                stage = this.model.getActiveItem().get('_index');
                this.playAudio(stage);
            }
        },
